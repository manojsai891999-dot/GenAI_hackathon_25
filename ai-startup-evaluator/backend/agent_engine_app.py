...
from backend.utils.gcs import create_bucket_if_not_exists
from backend.utils.tracing import CloudTraceLoggingSpanExporter
from backend.utils.typing import Feedback
...
def deploy_agent_engine_app(
    ...
    extra_packages: list[str] = ["./backend"],
    ...
    artifacts_bucket_name = f"{project}-ai-startup-evaluator-logs-data"
